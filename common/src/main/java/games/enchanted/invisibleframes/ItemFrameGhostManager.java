...
public class ItemFrameGhostManager {
    ...
    public void createGhost() {
        ...
        display.setPos(
            itemFrame.getX() + (-0.0312f * itemFrame.getDirection().getStepX()),
            itemFrame.getY() + (-0.0312f * itemFrame.getDirection().getStepY()),
            itemFrame.getZ() + (-0.0312f * itemFrame.getDirection().getStepZ())
        );
